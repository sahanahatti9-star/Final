...
const playlistData = {
  popular: [
    ...
    },
    {
      ...
      songs: [
        { name: "Island", src: "mixkit-island-beat-250.mp3" },
        { name: "Cat walk", src: "mixkit-cat-walk-371.mp3" },
        { name: "Bridge", src: "mixkit-bridge-n-98-621.mp3" },
        { name: "Beauty", src: "Beauty(chosic.com).mp3" },
        { name: "Bliss", src: "Luke-Bergs-Bliss(chosic.com).mp3" },
        { name: "Winter", src: "Winter-Long-Version(chosic.com).mp3" },
        { name: "", src: "" },
        { name: "", src: "" },
      ]
    },
  ...
  rock: [
    {
      ...
      songs: [
        { name: "How long", src: "Charlie Puth - _How Long_ [Official Video].mp3" },
        { name: "I dont wanna live forever", src: "WYWn4V7m21i-qppBhaUDAZuJ7JJHKUudoTL1RjJnjQ3hPMXfGQYUqaddHeLKeYShbt8bmzu1J8P_GPU-w0NZsojPnmg0hqtrNF51voOWD8IcDMIhO72xB-DLJbNML5lllibkeG3LtwctyfC2mIfvT1eeRfbGa3A2R3FQ_aE29X0Nx1Wjog.mp3" },
        { name: "Queen of hearts", src: "Starla_Edney_-_Queen_of_Hearts_(mp3.pm).mp3" },
        { name: "We don't talk anymore", src: "CharliePuth_-_We_Don_t_Talk_Anymore_(mp3.pm).mp3" },
        { name: "I like me better", src: "Lauv_-_I_Like_Me_Better_Official_Audio_(mp3.pm).mp3" },
        { name: "Safari", src: "Serena_-_Safari_(mp3.pm).mp3" },
        { name: "Gasolina", src: "Serena_-_Gasolina_erger.ru_2019_(mp3.pm).mp3" },
        { name: "Night changes", src: "songs/One_Direction_-_Night_Change_(mp3.pm).mp3" },
        { name: "Into you", src: "Ariana_Grande_-_Into_You_(mp3.pm).mp3" },
        { name: "Stitches", src: "Shawn_Mendes_-_Stitches_Radio_MeL0mAn_(mp3.pm).mp3" },
        { name: "Treat you better", src: "Shawn_Mendes_-_Treat_You_Better_ORIGINAL_(mp3.pm).mp3" },
        { name: "Friends", src: "Marshmello_Anne_Marie_-_Friends_(mp3.pm).mp3" },
        { name: "Lush life", src: "Zara_Larsson_-_Lush_Life_Europa_Plus_Ua_2016_(mp3.pm).mp3" },
        { name: "Side to side", src: "Ariana_Grande_-_Into_You_(mp3.pm).mp3" },
        { name: "One kiss", src: "Calvin_Harris_and_Dua_Lipa_-_One_kiss_(mp3.pm).mp3" },
        { name: "Attention", src: "songs/Charles_puth_-_Attention_(mp3.pm).mp3" },
        { name: "Heat waves", src: "Glass_Animals_-_Heat_Waves_(mp3.pm).mp3" },
        { name: "Kodak black", src: "Kodak-Black-NLE-Choppa-Ft-Jimin-of-BTS-Jvke-Muni-Long-Angel-Pt.-1-Official-Music-video.mp3" },
        { name: "", src: "" },
        { name: "", src: "" },
        { name: "", src: "" },
        { name: "", src: "" },
  ...
  jazz: [
    {
      ...
      cover: "kannada.jpg",
      songs: [
        { name: "Kele chaluve", src: "Kele_Cheluve_Full_Video_Song___Rangitaranga_Video_Songs___Nirup_Bhandari,_Radhika_Chetan,_Avantika_S(256k).mp3" },
        { name: "Ale Ale", src: "Ale_Ale___Audio_Song___Savaari___Raghu_Mukherjee___Srinagar_Kitty___Kamalini_Mukharji__M.Kadri(256k).mp3" },
        { name: "", src: "" },
        { name: "", src: "" },
      ]
    }
  ...
  dance: [
    {
      ...
      songs: [
        { name: "Patola", src: "Patola - Blackmail 320 Kbps.mp3" },
        { name: "High Rated Gabru", src: "High Rated Gabru - Nawabzaade 320 Kbps.mp3" },
        { name: "High Heels Te Nachche", src: "High Heels Te Nachche - Ki And Ka 320 Kbps.mp3" },
        { name: "Cin chin chu", src: "Chin_Chin_Chu(256k).mp3" },
      ]
    },

    {
      ...
      cover: "",
      songs: [
        { name: "Dippam Dappam", src: "Dippam Dappam (From Kaathuvaakula Rendu Kaadhal).mp3" },
        { name: "", src: "" },
        { name: "", src: "" },
        { name: "", src: "" },
      ]
